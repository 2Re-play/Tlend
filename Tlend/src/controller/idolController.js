...
exports.getSupportDetail = async (req, res, next) => {
  try {
    ...
    response.respondJson('Successfully get idol support detail data', result, res, 200)
  } catch (e) {
    console.log(e)
    response.respondOnError(e.message, res, 500)
  }
...
exports.getRewardDetail = async (req, res, next) => {
  try {
    ...
    response.respondJson('Successfully get idol reward detail data', result, res, 200)
  } catch (e) {
    console.log(e)
    response.respondOnError(e.message, res, 500)
  }
